...
/**
 * A full application dashboard built around the `Sidebar`: a navigation sidebar,
 * a top bar, a row of KPI cards, a lightweight overview chart, and a
 * recent-activity list. Swap the sample data arrays for your own.
 */
  ...
  return (
    <SidebarProvider>
      ...
      <Sidebar collapsible="offcanvas">
        <SidebarHeader style={{ paddingTop: insets.top + 8 }}>
      ...
      <SidebarInset>
          ...
          <View className="ml-auto flex-row items-center gap-2">
            <View className="hidden flex-row items-center sm:flex">
              <View className="relative">
                ...
                <Input placeholder="Search…" className="native:pl-8 h-9 w-44 pl-8" readOnly />
              </View>
            </View>
        ...
        <ScrollView
          className="flex-1"
          contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: insets.bottom + 48 }}
