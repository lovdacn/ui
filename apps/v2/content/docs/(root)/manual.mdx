...
```bash
yarn add class-variance-authority clsx tailwind-merge lucide-react-native react-native-reanimated react-native-gesture-handler @rn-primitives/portal @rn-primitives/slot
```
...
```bash
pnpm add class-variance-authority clsx tailwind-merge lucide-react-native react-native-reanimated react-native-gesture-handler @rn-primitives/portal @rn-primitives/slot
```
...
```bash
bun add class-variance-authority clsx tailwind-merge lucide-react-native react-native-reanimated react-native-gesture-handler @rn-primitives/portal @rn-primitives/slot
```
