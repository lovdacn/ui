...
const toggleVariants = cva(
  cn(
    'active:bg-muted group flex flex-row items-center justify-center hover:text-foreground aria-pressed:bg-muted gap-1 rounded-md text-sm font-medium',
    Platform.select({
  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline: cn(
          'active:bg-accent shadow-black/5 border-input hover:bg-muted border bg-transparent shadow-xs',
          Platform.select({
