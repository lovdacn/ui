  ...
  return (
    <>
      ...
      <MenubarPrimitive.Root
        className={cn(
          'bg-background border-border flex h-10 flex-row items-center shadow-black/5 sm:h-9 min-h-9 gap-1 rounded-md border p-1 shadow-xs',
          className
        )}
  ...
  return (
    <TextClassContext.Provider
      ...
      <MenubarPrimitive.Trigger
        className={cn(
          'group flex items-center sm:py-1 hover:bg-muted aria-expanded:bg-muted rounded-sm px-2 py-1 text-sm font-medium',
          Platform.select({
  ...
  return (
    <TextClassContext.Provider
      ...
      <MenubarPrimitive.SubTrigger
        className={cn(
          'active:bg-accent group flex flex-row items-center justify-between sm:py-1.5 gap-2 rounded-sm px-2 py-1.5 text-sm',
          Platform.select({
  ...
  return (
    <NativeOnlyAnimatedView entering={FadeIn}>
      <MenubarPrimitive.SubContent
        className={cn(
          'border-border border shadow-black/5 bg-popover text-popover-foreground min-w-32 rounded-md p-1 shadow-lg',
          Platform.select({
        ...
        <NativeOnlyAnimatedView
          ...
          <TextClassContext.Provider value="text-popover-foreground">
            <MenubarPrimitive.Content
              className={cn(
                'border-border border shadow-black/5 bg-popover min-w-36 rounded-md p-1 shadow-md',
                Platform.select({
                  web: cn(
  ...
  return (
    <TextClassContext.Provider
      ...
      <MenubarPrimitive.Item
        className={cn(
          'active:bg-accent group relative flex flex-row items-center sm:py-1.5 gap-2 rounded-sm px-2 py-1.5 text-sm',
          Platform.select({
            web: cn(
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      className={cn(
        'text-foreground sm:py-1.5 px-2 py-1.5 text-sm font-medium',
        inset && 'pl-8',
        className
      )}
      {...props}
