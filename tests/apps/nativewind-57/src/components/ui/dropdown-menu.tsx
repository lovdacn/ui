  ...
  return (
    <NativeOnlyAnimatedView entering={FadeIn}>
      <DropdownMenuPrimitive.SubContent
        className={cn(
          'border-border border shadow-black/5 bg-popover text-popover-foreground min-w-[96px] rounded-md p-1 shadow-lg',
          Platform.select({
          ...
          <NativeOnlyAnimatedView entering={FadeIn}>
            <TextClassContext.Provider value="text-popover-foreground">
              <DropdownMenuPrimitive.Content
                className={cn(
                  'border-border border shadow-black/5 bg-popover min-w-32 rounded-md p-1 shadow-md',
                  Platform.select({
                    web: cn(
  ...
  return (
    <TextClassContext.Provider value="text-sm text-popover-foreground select-none group-active:text-accent-foreground">
      <DropdownMenuPrimitive.CheckboxItem
        className={cn(
          'active:bg-accent group relative flex flex-row items-center sm:py-1.5 gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm',
          Platform.select({
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn(
        'sm:py-1.5 text-muted-foreground px-2 py-1.5 text-xs font-medium',
        inset && 'pl-8',
        className
      )}
      {...props}
