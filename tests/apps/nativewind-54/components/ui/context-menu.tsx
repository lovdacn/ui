  ...
  return (
    <TextClassContext.Provider
      ...
      <ContextMenuPrimitive.SubTrigger
        className={cn(
          'active:bg-accent group flex flex-row items-center justify-between sm:py-1.5 rounded-sm px-2 py-1.5 text-sm',
          Platform.select({
  ...
  return (
    <NativeOnlyAnimatedView entering={FadeIn}>
      <ContextMenuPrimitive.SubContent
        className={cn(
          'border-border shadow-black/5 bg-popover text-popover-foreground min-w-32 rounded-md border p-1 shadow-lg',
          Platform.select({
